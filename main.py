...
# Set CMD Title
ctypes.windll.kernel32.SetConsoleTitleW("Husko's Wolf-Awesome-Lite | v" + version)
...
def downloader():
    ...
    # Correct SVG
    with open(r'misc/wolf.svg', 'r') as file:
        data = file.read()
        data = data.replace("Generated by IcoMoon", "Generated by Wolf-Awesome-Lite on Github: https://github.com/Official-Husko/Wolf-Awesome-Lite")
    with open(r'misc/wolf.svg', 'w') as file:
        file.write(data)
        file.close()
    with open(r'misc/wolf.svg', 'r') as file:
        data = file.read()
